...
export default function ForgotPasswordPage() {
  ...
  const [error, setError] = useState<string | null>(null); const [captchaToken, setCaptchaToken] = useState<string | null>(null);
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    const { error: resetError } = await supabase.auth.resetPasswordForEmail(cleanEmail, { redirectTo: `${window.location.origin}/reinitialiser-mot-de-passe`, captchaToken });
    setLoading(false);
