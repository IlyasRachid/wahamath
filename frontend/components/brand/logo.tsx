  ...
  return (
    <div className={cn('flex items-center gap-2.5', className)}>
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        ...
        <path d="M 8 24 L 13 12 L 18 24 M 11 19 L 15 19" stroke={variant === 'light' ? '#fbfaf7' : '#fbfaf7'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      ...
      {showText && (
        <span
          ...
          style={{ color: variant === 'light' ? '#fbfaf7' : 'hsl(222 47% 11%)' }}
        >
          Waha<span style={{ color: accent }}>Math</span>
        </span>
      )}
    </div>
  );
