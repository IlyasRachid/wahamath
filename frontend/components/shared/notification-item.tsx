...
import { Bell, CalendarDays, MessageCircle, FileText, ShieldAlert, Info, Trash2 } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-1 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-destructive/10 hover:text-destructive disabled:cursor-not-allowed disabled:opacity-50"
      >
