...
export function TeacherStudentRoster({ classes, onStudentDeleted, onStudentChanged }: { classes: ClassRoster[]; onStudentDeleted: (studentId: string) => void; onStudentChanged: () => Promise<void> }) {
  ...
  const [instruction, setInstruction] = useState(''); const [instructionExercise, setInstructionExercise] = useState('none'); const [sendingInstruction, setSendingInstruction] = useState(false); const [exercises, setExercises] = useState<{ id: string; title: string; chapter: string }[]>([]);
